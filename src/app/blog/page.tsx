        ...
        <main>
            <section className="w-full bg-background pt-12 pb-20 md:pt-16 md:pb-28">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <span className="font-heading font-semibold text-sm text-primary uppercase tracking-wide mb-4 block">Blog</span>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2">
                            ...
                            <div className="p-8 md:p-10 flex flex-col justify-center">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="inline-flex items-center gap-2 font-heading font-semibold text-sm text-primary group-hover:gap-3 transition-all">
                        ...
                        {rest.map((post) => (
                            ...
                            >
                                ...
                                <div className="p-6 flex flex-col flex-grow">
                                    <h2 className="font-heading font-bold text-xl text-text-primary mb-3 group-hover:text-primary transition-colors line-clamp-2">
                                        {post.title}
                                    </h2>
            ...
            <section className="w-full bg-dark-background py-16 md:py-20">
                <div className="max-w-3xl mx-auto px-6 text-center">
                    <span className="font-heading font-semibold text-sm text-primary uppercase tracking-wide mb-4 block">Stay Updated</span>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                        <input
                            ...
                            className="flex-1 bg-white/10 border border-white/20 rounded-lg px-4 py-3 font-body text-sm text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-primary/60 focus:border-transparent transition-all"
                        />
                        <button className="bg-primary hover:bg-primary-hover text-white font-heading font-semibold text-sm px-6 py-3 rounded-lg transition-colors whitespace-nowrap shadow-lg shadow-primary/20">
                            Subscribe
                        </button>
                    </div>
