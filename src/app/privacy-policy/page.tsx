        ...
        <main>
            <section className="w-full bg-background py-16 md:py-24">
                <div className="max-w-3xl mx-auto px-6">
                    <h1 className="font-heading font-bold text-4xl md:text-5xl text-text-primary mb-8">Privacy Policy</h1>
                    <div className="prose prose-lg max-w-none font-body text-text-secondary space-y-6 leading-relaxed">
                        <p><strong>Last Updated:</strong> March 2026</p>
                        <h2 className="font-heading font-bold text-2xl text-text-primary">1. Information We Collect</h2>
                        ...
                        <h2 className="font-heading font-bold text-2xl text-text-primary">2. How We Use Your Information</h2>
                        ...
                        <h2 className="font-heading font-bold text-2xl text-text-primary">3. Cookies</h2>
                        ...
                        <h2 className="font-heading font-bold text-2xl text-text-primary">4. Data Security</h2>
                        ...
                        <h2 className="font-heading font-bold text-2xl text-text-primary">5. Contact</h2>
